function [S,deltaY2,pondlost]=isolatedpondexpansion(z,S,A,N,M,dx,dt,zpondcr,maxdpond,aPEXP,pondlost,Active);
...
er=a(A(q(a))==1 & S(q(a))==0  & Active(q(a))==1); %find the neightr cell that is a non-pond cell, and is active
